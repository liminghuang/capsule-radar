...
#define RIPPLE_GLOW_WIDTH_PX 12            // outer radius of the two-band ripple halo
#define RIPPLE_GLOW_OPACITY_PERCENT 52     // innermost halo intensity relative to the ripple edge
#define RIPPLE_GLOW_LAYERS 2               // visible gradient while keeping the span path lightweight
